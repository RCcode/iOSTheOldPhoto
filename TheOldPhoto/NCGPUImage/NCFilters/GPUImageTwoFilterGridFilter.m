//
//  GPUImageTwoFilterGridFilter.m
//  GPUImage
//
//  Created by MAXToooNG on 15/5/15.
//  Copyright (c) 2015年 Brad Larson. All rights reserved.
//
#import "GPUImageTwoFilterGridFilter.h"

NSString *const kGPUImageTwoFilterGridTextureVertexShaderString = SHADER_STRING
(
...
@implementation GPUImageTwoFilterGridFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kGPUImageTwoFilterGridTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
        return nil;
    }
...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        filterSecondPositionAttribute = [filterProgram attributeIndex:@"position2"];
...
- (void)renderToTextureWithVertices:(const GLfloat *)vertices textureCoordinates:(const GLfloat *)textureCoordinates;
{
    ...
    glVertexAttribPointer(filterPositionAttribute, 2, GL_FLOAT, 0, 0, v1);
        glVertexAttribPointer(filterSecondPositionAttribute, 2, GL_FLOAT, 0, 0, v1);
    glVertexAttribPointer(filterTextureCoordinateAttribute, 2, GL_FLOAT, 0, 0, v2);
