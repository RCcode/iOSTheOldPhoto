...
NSString *const kGPUImageLookup1FragmentShaderString = SHADER_STRING
(
...
@implementation GPUImageMirrorLookupFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUImageLookup1FragmentShaderString]))
    {
		return nil;
    }
